...
$del_id = $_GET['del_id'];
// print $del_id;
RestoreDeleted($del_id);
}


include("./menu.inc.php");
$extra = " and deleted LIKE 'true' ORDER BY category, title";
...
function myFunction(del_id, del_title) {
 var r = confirm("Do you really want to restore " + del_title + "?");
...
<label onclick="myFunction(<?php print $d2['id']; ?>, '<?php print $d2['title']; ?>')">Restore</label>
